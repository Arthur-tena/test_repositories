  ...
  cmpt_bb=0
   while (cmpt_bb<p) {
    ...
    data_tab2$tab[X][Y]=data_case$bombe[1] ##On veut aue tab[X][Y] recoive T/F de la data_case$bombe
     ifesle(tab[X][Y]$data_case$bombe==TRUE, cmpt_bb, (cmpt_bb+1)&(data_tab2$case_jouable[2])) ## S'il y a déja une bombe on n'augmente pas le compteur de bombe
   }
}
